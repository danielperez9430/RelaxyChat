(function() {
    ...
    var randomColor = function() {   
        var colors = ['playa', 'costa', 'ducha','monte', 'mar','aqua', 'castillo', 'estrella', 'chat', 'relaxy'];   
        return colors[(Math.random() * colors.length) >>> 0];
    };

    var randomCat = function() {   
        var cats = ['cascada', 'flores', 'isla', 'palmera', 'paseo', 'transparente', 'relax', 'atardecer', 'brisa', 'monte', 'estrella'];           
